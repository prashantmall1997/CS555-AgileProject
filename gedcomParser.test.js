...
test("Test US39", () => {
  expect(US39("gedcomTestData_US39")).toBe(false);
});

test("Test US42", () => {
  expect(US42("gedcomTestData_US42")).toBe(false);
});

test("Test US33", () => {
  expect(US33("gedcomTestData_US33")).toBe(false);
});

test("Test US38", () => {
  expect(US38("gedcomTestData_US38")).toBe(false);
});